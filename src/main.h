...
static const char *const haLiveDescriptor[][4]{
    ...
    {DESCR_AC_Out_Effective_Voltage, DESCR_export, DESCR_V, DESCR_voltage},
    ...
    {DESCR_Battery_avg_Voltage, "home-battery", DESCR_V, DESCR_voltage},
    {DESCR_Battery_avg_Current, "home-battery", DESCR_A, DESCR_current},
    {DESCR_Battery_avg_Power, "home-battery", DESCR_W, DESCR_power},
    {DESCR_Inverter_avg_Charge_Current, "battery-charging-outline", DESCR_A, DESCR_current},
    ...
    {DESCR_Output_effective_current, DESCR_export, DESCR_A, DESCR_current},
    ...
    {DESCR_PV_Charging_avg_Power, DESCR_solar_power_variant, DESCR_W, DESCR_power},
    {DESCR_Inverter_Charging_Power, "ev-station", DESCR_W, DESCR_power},
    {DESCR_Input_Power, "transmission-tower-import", DESCR_W, DESCR_power},
