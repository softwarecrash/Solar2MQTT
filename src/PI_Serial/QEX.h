bool PI_Serial::PIXX_QEX()
{
  if (isPi30LikeProtocol(protocol))
  {
    ...
    liveData.remove(DESCR_PV_Generation_Month);
    liveData.remove(DESCR_PV_Generation_Day);
    liveData.remove(DESCR_AC_In_Generation_Sum);
    liveData.remove(DESCR_AC_In_Generation_Year);
    liveData.remove(DESCR_AC_In_Generation_Month);
    liveData.remove(DESCR_AC_In_Generation_Day);
