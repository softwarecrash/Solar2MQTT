...
inline static const modbus_register_t registers_live[] = {
    ...
    {15201, MODBUS_TYPE_HOLDING, REGISTER_TYPE_CUSTOM_VAL_NAME, "PV_Charger_Workstate", 0, {.bitfield = {
                                                                                                        "Initialization",
                                                                                                        "Self Test",
                                                                                                        "Work",
                                                                                                        "Stop",
    ...
    {15219, MODBUS_TYPE_HOLDING, REGISTER_TYPE_U16, DESCR_Accumulated_Day},

    {25201, MODBUS_TYPE_HOLDING, REGISTER_TYPE_CUSTOM_VAL_NAME, DESCR_Inverter_Operation_Mode, 0, {.bitfield = {"Power On", "Self Test", "OffGrid", "GridTie", "ByPass", "Stop", "GridCharging"}}},
    ...
    {25216, MODBUS_TYPE_HOLDING, REGISTER_TYPE_DIEMATIC_TWO_DECIMAL, DESCR_AC_Out_Percent},
    {25225, MODBUS_TYPE_HOLDING, REGISTER_TYPE_DIEMATIC_TWO_DECIMAL, DESCR_AC_Out_Frequency},
    {25226, MODBUS_TYPE_HOLDING, REGISTER_TYPE_DIEMATIC_TWO_DECIMAL, DESCR_AC_In_Frequency},
    {25233, MODBUS_TYPE_HOLDING, REGISTER_TYPE_U16, DESCR_AC_Radiator_Temperature},
