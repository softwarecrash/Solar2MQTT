...
#define DESCR_DCDC_Temperature "DCDC_Temperature"
#define DESCR_AC_Radiator_Temperature "AC_Radiator_Temperature"
#define DESCR_Accumulated_Day "Accumulated_Day"
...
#define DESCR_Allow_SCC_On_Flag "Allow_SCC_On_Flag"              // Allow SCC on flag
